...
import com.one.digitalinnovation.santanderdevweek.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindOnView(conta: Conta) {
        ...
        findViewById<TextView>(R.id.tv_cartao_valor).text = conta.cartao.numeroCartao
    }
